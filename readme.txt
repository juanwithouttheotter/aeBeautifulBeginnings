...
Font:
  - We set up the Allura and Alex Brush font family stacks in the CSS but we don't have the fonts included --fonts included via google fonts api

Site Logos:
  - We need to account for retina screens -- Added the @media labels found and changed the img src to bb-logo-2x when criteria met. 

Icons:
  - We haven't been able to add the icons to the setup yet -- set up, what is the purpose of the social sprite? eliminate google plus has been sunset.
  - Hamburger menu, cart, and search icons haven't been added -- cropped usin photoshop and added. a tiny bit skew will go back. 
